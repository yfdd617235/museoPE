      ...
      <div className="scroll-snap-container flex flex-col pt-10">
        <div id="home" className="snap-section relative h-screen w-full flex justify-center items-center overflow-hidden">
          <video
            ...
            poster={`${import.meta.env.BASE_URL}photo1.jpg`}
            muted
            autoPlay
            loop
            playsInline
          ...
          <div className="">
            <div className="gap-10 flex flex-col md:flex-row justify-center items-center mx-auto px-4 lg:px-20 2xl:px-60">
              ...
              <div className="md:w-1/2 pt-10 md:py-10">
                <h2 className="font-bold md:text-2xl">{t('whoarewe.whoarewe')}</h2>
                <p className="">
        ...
        {/*Gallery */}
        <div id="gallery" className="snap-section section py-1 bg-[#BD612E]">
          <CarruselClientes />
        </div>

        {/*Legacy*/}
        <div id="legacy" className="bg-[#F5E9D6] snap-section section flex flex-col gap-20 text-base md:text-lg py-20">
          ...
          <div className="bg-[#F5E9D6]">
            <div className="py-50 gap-5 flex flex-col md:flex-row justify-center items-center mx-auto px-4 md:w-1/2">
              ...
              <div className="text-[#BD612E] drop-shadow-2xl md:w-3/4">
        ...
        <div id="contact" className="snap-section section bg-[#633F20] text-white w-full text-left py-20 bg-repeat bg-center min-h-[200px] flex justify-center text-base md:text-lg">
          ...
          <div className="w-full px-4 lg:px-20 2xl:px-60 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 items-center ">
            <div className="h-40 lg:h-40 flex p-2">
              <img
            ...
            <div className="flex items-center justify-center md:justify-left">
              <div className="flex flex-col space-y-3 text-left">
                ...
                <button
                  className="bg-[#F5E9D6] text-[#633F20] font-bold px-10 py-1 border-2 border-[#633F20] hover:bg-[#C47630] transition duration-300 text-base md:text-sm lg:text-lg"
                >
                  {t('reservation.text')}
                </button>
              ...
              <div className="flex flex-col space-y-3 text-left">
                ...
                <div className="flex items-center">
                  ...
                  >
                    ...
                    <span>Calle 12 #10-27, Vía Las Palmas, Medellín</span>
                  </a>
                </div>
        ...
        <footer className="bg-black text-white text-sm bottom-0 w-full text-center py-1">
